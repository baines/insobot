...
const IRCModuleCtx irc_mod_ctx = {
	...
	.commands    = DEFINE_CMDS (
		[ALIAS_ADD]         = CMD("alias"     ) CMD("alias+"   ),
		[ALIAS_ADD_GLOBAL]  = CMD("galias"    ) CMD("galias+"  ),
		[ALIAS_DEL]         = CMD("unalias"   ) CMD("delalias" ) CMD("rmalias"    ) CMD("alias-"),
		[ALIAS_DEL_GLOBAL]  = CMD("gunalias"  ) CMD("gdelalias") CMD("grmalias"   ) CMD("galias-"),
		[ALIAS_LIST]        = CMD("lsalias"   ) CMD("lsa"      ) CMD("listalias"  ) CMD("listaliases"),
		[ALIAS_LIST_GLOBAL] = CMD("lsgalias"  ) CMD("lsga"     ),
