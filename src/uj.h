...
void           uj_lex_init (struct uj_lexer*, char* work_mem, size_t work_mem_size);
...
static _Bool uj_parser_cb(struct uj_lexer* p, enum uj_type type, const char* data, size_t len){
